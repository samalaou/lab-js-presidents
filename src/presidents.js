...
function  countYearsInOffice(presidentsArr) {
  return presidentsArr.reduce((totalYears, president) => president.leftOffice ? totalYears + president.leftOffice - president.tookOffice : totalYears, 0)
}
...
function countRepublicanPresidents(presidentsArr) {
  return presidentsArr.reduce((numRepublican, president) => president.party === "Republican" ? numRepublican + 1 : numRepublican, 0)
}
